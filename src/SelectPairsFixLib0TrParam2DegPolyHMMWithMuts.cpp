...
SelectPairsFixLib0TrParam2DegPolyHMMWithMuts::SelectPairsFixLib0TrParam2DegPolyHMMWithMuts(std::vector<DepthPair*>* depths, std::vector<std::string>* sampleList, std::vector<MutationList*>* mutListVec, gsl_vector* allIndEstMutCounts, gsl_vector* fixedParams, int maxPloidy, int numPairs, int numPairsToSummarize, int ordering, unsigned int seed, gsl_matrix* stage1NearestCellIdxMat, int numBranchesToEst) : SelectPairsFixLib0TrParam2DegPolyHMM (depths, sampleList, fixedParams, maxPloidy, numPairs, numPairsToSummarize, ordering, seed, stage1NearestCellIdxMat, numBranchesToEst) {
...
SelectPairsFixLib0TrParam2DegPolyHMMWithMuts* SelectPairsFixLib0TrParam2DegPolyHMMWithMuts::create(std::vector<DepthPair*>* depths, std::vector<std::string>* sampleList, std::vector<MutationList*>* mutListVec, gsl_vector* allIndEstMutCounts, gsl_vector* fixedParams, int maxPloidy, int numPairs, int numPairsToSummarize, int ordering, unsigned int seed, gsl_matrix* stage1NearestCellIdxMat, gsl_vector* meanVarianceCoefVec, bool preallocIntermediates) {
  SelectPairsFixLib0TrParam2DegPolyHMMWithMuts* hmm = new SelectPairsFixLib0TrParam2DegPolyHMMWithMuts(depths, sampleList, mutListVec, allIndEstMutCounts, fixedParams, maxPloidy, numPairs, numPairsToSummarize, ordering, seed, stage1NearestCellIdxMat, numPairs * 3); // numPairs*3 numBranchesToEst
  hmm->makeHMMPairs(meanVarianceCoefVec, preallocIntermediates);
  return hmm;
}
// copied from AllPairsFixLib0TrParam2DegPolyHMMWithMuts
void SelectPairsFixLib0TrParam2DegPolyHMMWithMuts::makeOneHMMPair(int i, int j, bool preallocIntermediates) {
...
SelectPairsFixLib0TrParam2DegPolyHMMWithMuts::~SelectPairsFixLib0TrParam2DegPolyHMMWithMuts() {
  // TODO
}

gsl_vector* SelectPairsFixLib0TrParam2DegPolyHMMWithMuts::getAllPairedEstMutCounts() {
