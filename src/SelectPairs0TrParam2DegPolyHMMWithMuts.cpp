...
SelectPairs0TrParam2DegPolyHMMWithMuts::SelectPairs0TrParam2DegPolyHMMWithMuts(std::vector<DepthPair*>* depths, std::vector<std::string>* sampleList, std::vector<MutationList*>* mutListVec, gsl_vector* allIndEstMutCounts, gsl_vector* fixedParams, int maxPloidy, int numFixedLibs, int numPairs, int numPairsToSummarize, int ordering, unsigned int seed, gsl_matrix* stage1NearestCellIdxMat, int numBranchesToEst) : SelectPairs0TrParam2DegPolyHMM(depths, sampleList, fixedParams, maxPloidy, numFixedLibs, numPairs, numPairsToSummarize, ordering, seed, stage1NearestCellIdxMat, numBranchesToEst) {
...
SelectPairs0TrParam2DegPolyHMMWithMuts* SelectPairs0TrParam2DegPolyHMMWithMuts::create(std::vector<DepthPair*>* depths, std::vector<std::string>* sampleList, std::vector<MutationList*>* mutListVec, gsl_vector* allIndEstMutCounts, gsl_vector* fixedParams, int maxPloidy, int numPairs, int numPairsToSummarize, int ordering, unsigned int seed, gsl_matrix* stage1NearestCellIdxMat, gsl_vector* meanVarianceCoefVec, bool preallocIntermediates) {
  SelectPairs0TrParam2DegPolyHMMWithMuts* hmm = new SelectPairs0TrParam2DegPolyHMMWithMuts(depths, sampleList, mutListVec, allIndEstMutCounts, fixedParams, maxPloidy, 0, numPairs, numPairsToSummarize, ordering, seed, stage1NearestCellIdxMat, numPairs * 3); // 0 numFixedLibs, numPairs*3 numBranchesToEst
  hmm->makeHMMPairs(meanVarianceCoefVec, preallocIntermediates);
  return hmm;
}
void SelectPairs0TrParam2DegPolyHMMWithMuts::makeOneHMMPair(int i, int j, bool preallocIntermediates) {
...
SelectPairs0TrParam2DegPolyHMMWithMuts::~SelectPairs0TrParam2DegPolyHMMWithMuts() {
  // TODO
}

gsl_vector* SelectPairs0TrParam2DegPolyHMMWithMuts::getAllPairedEstMutCounts() {
